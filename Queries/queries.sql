...
-- retirement eligibility between 1952 and 1955
...
-- (Did not run) create filtered emp_info table 
...
-- create filtered emp_info table
SELECT e.emp_no,
    e.first_name,
e.last_name,
    e.gender,
...
-- Skill Drill sales & Development table
SELECT ri.emp_no,
ri.first_name,
ri.last_name,
d.dept_name
